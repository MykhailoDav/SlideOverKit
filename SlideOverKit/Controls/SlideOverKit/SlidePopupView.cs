...
public class SlidePopupView : Border
{
    ...
    public static readonly BindableProperty BackgroundViewColorProperty = BindableProperty.Create(nameof(BackgroundViewColor), typeof(Color), typeof(SlidePopupView), Colors.Gray);
