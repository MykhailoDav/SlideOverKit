...
internal class HorizontalGestures : GestureBase, IDragGesture, IDisposable
{
    ...
    static void CheckViewBound(SlideMenuView view)
    {
    ...
    public void DragMoving(double x, double y)
    {
        ...
        RequestLayout?.Invoke(_left, _top, _right, _bottom, _density);
    ...
    public void LayoutShowStatus()
    {
        ...
        NeedShowBackgroundView?.Invoke(true, 1);
    }
    ...
    public void LayoutHideStatus()
    {
        ...
        NeedShowBackgroundView?.Invoke(false, 0);
        _willShown = true;
    }
