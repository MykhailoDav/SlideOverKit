...
public class SlideOverKitDroidHandler
{
    ...
    void AddMenu()
    {
        ...
        if (_popMenuOverlayRenderer == null)
        {
            ...
            menu.Layout(new Microsoft.Maui.Graphics.Rect(
            ...
            _pageRenderer.AddView(rootView);
            _pageRenderer.BringChildToFront(rootView);
    ...
    void AddPopup()
    {
        ...
        _popupBasePage.ShowPopupAction = (key) =>
        {
            ...
            _pageRenderer.AddView(_popupRenderer.View);
            _pageRenderer.BringChildToFront(_popupRenderer.View);
    ...
    Rect LayoutPopup()
    {
        ...
        if (popup.TargetControl != null)
        {
            ...
            if (global::Android.App.Application.Context.Theme.ResolveAttribute(global::Android.Resource.Attribute.ActionBarSize, tv, true))
            {
                actionBarHeight = TypedValue.ComplexToDimensionPixelSize(tv.Data, global::Android.App.Application.Context.Resources.DisplayMetrics);
            }
        ...
        popup.Layout(new Microsoft.Maui.Graphics.Rect(x, y, width, height));
    ...
    void HideBackgroundForPopup()
    {
        ...
        if (_popupRenderer != null)
        {
            ...
            {
                InputMethodManager inputManager = (InputMethodManager)global::Android.App.Application.Context.GetSystemService(Context.InputMethodService);
    ...
    void ShowBackgroundOverlay(double alpha)
    {
        ...
        double value = (double)(alpha * _basePage.SlideMenu.BackgroundViewColor.Alpha);
        if (_backgroundOverlay != null)
        {
        ...
        _backgroundOverlay = new global::Android.Widget.LinearLayout(global::Android.App.Application.Context);
        _pageRenderer.AddView(_backgroundOverlay);
    ...
    void HideMenu(object sender, global::Android.Views.View.TouchEventArgs e)
    {
        _basePage.HideMenuAction();
    }

    void HidePopup(object sender, global::Android.Views.View.TouchEventArgs e)
    {
        _popupBasePage.HidePopupAction();
    }

    void ShowBackgroundForPopup(global::Android.Graphics.Color color)
    {
        if (_popupBasePage == null)
        {
            return;
...
class AnimatorListener : Java.Lang.Object, global::Android.Animation.Animator.IAnimatorListener
{
    IDragGesture _dragGesture;
    bool _isShow;
